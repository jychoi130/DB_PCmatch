			...
			<form method="post" action="login_ok_all.php">
				<table align="center" border="0" cellspacing="0" width="300">
        			<tr>
                		...
                		<input type="text" name="Cid" placeholder="아이디" class="inph">
            		</td>
        		...
        		<tr>
            		<td width="130" colspan="1"> 
               		<input type="password" name="Cpw" placeholder="비밀번호" class="inph">
            	</td>
				<tr>
            		<td width="130" colspan="1"> 
               		<input type="text" name="check" placeholder="개발자=0,사용자=1" class="inph">
            	</td>
        	</tr>
        	<tr>
           		<td colspan="3" align="center" class="mem"> 
				   <br>
                      <a href="/signup_all.php">사용자 회원가입</a>
					  <a href="/signup_dev.php">개발자 회원가입</a>
           </td>
        </tr>
    </table>
  </form>
