...
<div id="board_area"> 
    <table class="list-table">
      <thead>
        ...
        <?php
          $sql = mq("select * from project where pid=any(select register.pid from register inner join project on register.Did='" . $Did . "')");
          $manager=mq("select register.Cid from register inner join project on register.Pid=project.pid && register.Did='" . $Did . "'");
          $n=1;
          //echo print_r($sql);
          echo "<tbody>";
